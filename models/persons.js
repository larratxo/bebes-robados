...
Schema.Persons = new SimpleSchema({
  ...
  nombreCompleto: { type: String, label: 'Nombre completo del niño/a si llegó a registrarse:', optional: true },
  ...
  fechaFallecimientoEsAprox: { type: Boolean, optional: true, label: '¿La fecha del fallecimiento es aproximada?',
                               autoform: {afFieldInput: {type: 'boolean-radios', trueLabel: 'Sí', falseLabel: 'No'}}},
  nombreCompletoMadre: { type: String, optional: true, label: 'Nombre y apellidos de la madre:' },
  nombreCompletoPadreOConyuge: { type: String, optional: true, label: 'Nombre y apellidos del padre:' },
